...
#define MODIFIER_LAYER 1
#define FUNCTION_LAYER 2
#define TENKEY_LAYER 3
...
[FUNCTION_LAYER] = { /* Functions */
  ...
  {RESET, KC_TRNS, KC_TRNS, KC_TRNS, FUNC(1),   KC_TRNS,   KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, FUNC(5), FUNC(6)}
},
[TENKEY_LAYER] = { /* TENKEY */
...
const uint16_t PROGMEM fn_actions[] = {
    ...
    [3] = ACTION_LAYER_MOMENTARY(TENKEY_LAYER),
